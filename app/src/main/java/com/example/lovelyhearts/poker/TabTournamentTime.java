...
public class TabTournamentTime extends ListActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.tab_tournament_time);
        //----------data------------
    ...
    public class ListViewAdapter extends ArrayAdapter<Tournament> {
        ...
        public View getView(int position, View convertView, ViewGroup parent){
            ...
            if(convertView == null){
                    convertView=inflater.inflate(R.layout.row_two_column, parent, false);
    ...
    public void updateAdapter(List<Tournament> objects) {
        setListAdapter(new ListViewAdapter(TabTournamentTime.this, R.layout.row_two_column, objects));
    }
